    ...
    methods
        ...
        function animateResults(obj, time, discrete_time, global_trajectory, path, parameters, varargin)
            ...
            if args.plot
                ...
                car_profile = carProf(parameters(2),0.5*parameters(2));
        ...
        function [Nodes, Edges] = buildDynProgGraph(obj, sampling_time, initial_state, path_to_track, allowed_u, parameters, varargin)
            ...
            %set up first node. 
            initial_position = interp1(path_to_track.s_coordinate, path_to_track.coordinates, initial_state(1));
            orientation = interp1(path_to_track.s_coordinate, path_to_track.orientation, initial_state(1)) + initial_state(3); 
